...
public class BookStackTest {
    ...
    public void should_store_books_in_the_book_stack() {
        ...
        assertThat(bookStack.getBookList_old(), containsString("123. book123"));
    }

    @Test
    public void should_add_default_book_in_book_stack_when_init_book_stack() {
        bookStack.initBookStack();
        assertThat(bookStack.getBookList_old(), containsString("1. Agile China"));
        assertThat(bookStack.getBookList_old(), containsString("2. XP"));
    }
